...
## Originality
Not another memory store or generic tool router. Iolaus focuses on the **execution commit boundary**: when real-world agent actions may safely become shared graph state and future learning signal.
